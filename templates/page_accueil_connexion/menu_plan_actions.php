...
<style>
 ...
 <!-- <a class="navbar-brand" href="#">Navbar</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <p><a href="{{path('fiche_dactions')}}">- Enregistrer une action</a> <br/> <a href="{{path('recherche_action')}}">- Consulter toutes les actions</a> <br/> <a href="{{path('app_tableau_bord_action')}}">- Tableau de bord</a></p>
